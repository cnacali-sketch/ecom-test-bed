...
class TestSkuEndpoint:
    def test_returns_requested_count_of_skus(self, client: TestClient):
    ...
    def test_returns_422_on_invalid_brand(self, client: TestClient):
        response = client.post(
            "/api/inventory/sku",
    ...
    def test_returns_422_on_zero_count(self, client: TestClient):
        response = client.post(
            "/api/inventory/sku",
...
class TestBarcodeEndpoint:
    def test_returns_png_bytes_for_ean13(self, client: TestClient):
        response = client.post(
    ...
    def test_returns_svg_bytes_for_upca(self, client: TestClient):
        response = client.post(
            "/api/inventory/barcode",
    ...
    def test_returns_422_on_invalid_code_length(self, client: TestClient):
        response = client.post(
            "/api/inventory/barcode",
